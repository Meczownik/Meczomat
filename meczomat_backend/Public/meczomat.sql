...
DELIMITER ;;
/*!50003 CREATE*/  /*!50003 TRIGGER `matches_after_insert` AFTER INSERT ON `matches` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/  /*!50003 TRIGGER `matches_after_update` AFTER UPDATE ON `matches` FOR EACH ROW BEGIN
